...
import techPng1 from "../../assets/technology/image-launch-vehicle-portrait.jpg";
...
const Technology = () => {
  ...
  let arrayTech = data.technology
    const desiredTech = arrayTech.find(item => item.id === 1);
    ...
    <div className="tech">
      {
        desiredTech && (
          ...
          : {backgroundColor: '#9f9d9d', height: '60px', width: '60px', borderRadius: '50%',   textAlign: "center",
            ...
            <div className="right">
              <img src={techPng1} alt={desiredTech.name} />
